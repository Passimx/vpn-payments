export default {
  ...
  key_traffic_limit_exceeded:
    'По Premium-ключу израсходован трафик по тарифу. Ключ отключён. Чтобы снова пользоваться VPN — оформите новый ключ.',
  ...
  ref_link_description:
    'Получайте 30% от всех пополнений ваших друзей в течение первых 90 дней! Деньги будут мгновенно зачисляться на ваш баланс.\nЧтобы скопировать ссылку, просто нажмите на нее',
};
