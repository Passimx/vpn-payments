export default {
  ...
  subscription_link_happ: 'Ссылка подписки (INCY)',
  instruction_happ_auto:
    'Если у вас установлен INCY — нажмите кнопку ниже: приложение откроется и всё настроится автоматически.',
  add_happ: '⚡ Добавить конфигурацию в INCY',
