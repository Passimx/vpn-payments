export default {
  ...
  key_traffic_limit_exceeded:
    'По Premium-ключу израсходован трафик по тарифу. Ключ отключён. Чтобы снова пользоваться VPN — продлите ключ и дополнительный трафик к нему прибавится.',
  ...
  select_vpn_type_message:
    ...
    '- На парковке\n' +
    'У него есть лимит по трафику — поэтому рекомендуется приобритать с ним обычный тариф.',
