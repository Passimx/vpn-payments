export default {
  ...
  open_download_app: 'Open the downloaded app',
  welcome: 'Welcome to PassimX VPN!\nLearn how to use the bot in the section',
  ...
  improve_balance: 'Balance topped up by',
  my_keys: 'My keys',
  rub: 'RUB',
  ...
  comment: 'Comment',
  allowed_jettons: 'Accepted coins',
  click_for_the_copy: 'To copy, just click <b>once</b>\n\n',
  payment_inf: 'PAYMENT DETAILS',
  payment: 'Payment',
  processing: 'Processing...',
  click_start: 'First click',
  country: 'Country',
  ...
  add_happ: 'Add a configuration in the Happ app',
